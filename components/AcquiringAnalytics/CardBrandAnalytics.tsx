  ...
  if (!data) {
    return (
      <section className="bg-white border border-slate-200 rounded-3xl p-8 shadow-lg">
        <p className="text-base text-slate-500">Card brand analytics will appear after data upload.</p>
      </section>
    );
  }
    ...
    <section className="space-y-8">
      <div className="bg-white border border-slate-200 rounded-3xl p-8 shadow-lg">
        <div className="flex items-center justify-between mb-6">
          <div>
            <p className="text-xs font-semibold text-blue-700 uppercase tracking-widest">Card Brand Performance</p>
            <h3 className="text-2xl font-extrabold text-slate-900">Success Rate by Brand</h3>
          </div>
        </div>
        <div className="h-64">
      ...
      {brands.map((brand: BrandMetrics) => (
        <div key={brand.brand} className="bg-white border border-slate-200 rounded-3xl p-8 shadow-lg">
